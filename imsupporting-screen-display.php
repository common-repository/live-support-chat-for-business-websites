...
add_action('wp_footer','ims_main');
// add_action('wp_footer','ims_main'); May be better going forward.. maybe in next relase .46
...
if ($code == "1"){
  $baselink = "Free Live Chat Software";
}
if ($code == "2"){
  $baselink = "Live Chat Plugin";
}
if ($code == "3"){
  $baselink = "Free Live Chat Plugin";
}
if ($code == "4"){
  $baselink = "Free Live Chat";
}
if ($code == "5"){
  $baselink = "Live Support Chat";
}
if ($code == "6"){
  $baselink = "Live Support Plugin";
}
if ($code == "7"){
  $baselink = "Free Live Chat";
}
if ($code == "8"){
  $baselink = "Free Chat Software";
}
if ($code == "9"){
  $baselink = "Wordpress Chat Plugin";
}
...
document.write('<a href="javascript:openSupport(\'<?php echo $ims_siteid; ?>\',\'Welcome\');"><img src="//status.imsupporting.com/status.php?siteid=<?php echo $ims_siteid; ?>&amp;style=<?php echo $ims_imageid; ?>&amp;docref='+docref+'" border="0" alt="live chat software" title="Start your free live chat"/></a>');
//-- Stop hiding script -->
</SCRIPT>
</div>
<?php 
